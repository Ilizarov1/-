...
SubType2.prototype.colors.push('black'); // 修改无效
...
function inheritPrototype(subType, superType) {
    var prototype = Object.create(superType.prototype); //创建原型副本而不是调用超类构造函数
...
console.log('SuperType4.prototype:', SuperType4.prototype);

SubType4.prototype.sayAge = function () {
    console.log(this.age);
};

const sub4 = new SubType4('a2', 16);
